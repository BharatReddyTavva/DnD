...
function modalDemoCtrl($scope, $uibModal) {
    ...
    $scope.open = function () {
        ...
        var modalInstance = $uibModal.open({
            templateUrl: 'app/views/modal_example.html',
    ...
    $scope.open1 = function () {
        var modalInstance = $uibModal.open({
            templateUrl: 'app/views/modal_example1.html',
            controller: 'ModalInstanceCtrl'
        });
    };
    ...
    $scope.open2 = function () {
        var modalInstance = $uibModal.open({
            templateUrl: 'app/views/modal_example2.html',
            controller: 'ModalInstanceCtrl',
    ...
    $scope.open3 = function (size) {
        var modalInstance = $uibModal.open({
            templateUrl: 'app/views/modal_example3.html',
            size: size,
            controller: 'ModalInstanceCtrl'
        });
    };
...
function notifyCtrl($scope, notify) {
    ...
    $scope.inspiniaTemplate = 'app/views/common/notify.html';
...
function idleTimer($scope, Idle, notify) {
    ...
    $scope.$on('IdleStart', function () {
        notify({
            ...
            templateUrl: 'app/views/common/notify.html'
        });
...
angular
    ...
    .controller('deleteBrandModalInstanceCtrl', deleteBrandModalInstanceCtrl)
    .controller('productTagsCtrl', productTagsCtrl) //Products Tag Controller
    .controller('addTagModalInstanceCtrl', addTagModalInstanceCtrl)
